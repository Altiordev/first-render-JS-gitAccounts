...
const domUser = users.map((user) => {
    ...
    <div class="card_texts">
        <div class="card_text login">
            <i class="fa-solid fa-user"></i>
            <div class="text">${user.login}</div>
        </div>
        <div class="card_text link">
            <i class="fa-solid fa-link fa-fade"></i>
            <a href="${user.html_url}" class="text" target="_blank">link to account</a>
        </div>
    </div>
    </div>`
})

cards.innerHTML = domUser.join('')